...
public class Image {
    ...
    //The table (primary key) is referenced by the 'image' field in the 'images' table
    //cascade = CascadeType.REMOVE specifies that if a record in 'images' table is deleted, then all the records in 'comment' table associated to that particular record in 'users' table will be deleted first and then the record in the 'images' table will be deleted
    //FetchType is LAZY
